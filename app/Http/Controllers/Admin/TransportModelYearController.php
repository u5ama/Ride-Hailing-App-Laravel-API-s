...
{
    /**
     * Display a listing of the TransportModelYear.
     *
    ...
    /**
     * Show the form for creating a new TransportModelYear.
     *
     * @return Application|Factory|View
     */
    ...
    /**
     * Store a newly created TransportModelYear in storage.
     *
     * @param Request $request
     * @return JsonResponse
     */
    ...
    /**
     * Display the specified TransportModelYear.
     *
     * @param int $id
     * @return void
     */
    ...
    /**
     * Show the form for editing the specified TransportModelYear.
     *
     * @param int $id
     * @return Application|Factory|View
     */
    ...
    /**
     * Update the specified TransportModelYear in storage.
     *
     * @param Request $request
     * @param int $id
     * @return void
    ...
    /**
     * Remove the specified TransportModelYear from storage.
     *
     * @param int $id
     * @return JsonResponse
     */
