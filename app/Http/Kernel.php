...
//        ],
    ...
    protected $routeMiddleware = [
        ...
        'languageCheck' => \App\Http\Middleware\LanguageMiddleware::class,
        'adminLanguage' => \App\Http\Middleware\AdminLanguage::class,
        'companyLanguage' => \App\Http\Middleware\CompanyLanguage::class,
        'jwt.verify' => \App\Http\Middleware\JwtMiddleware::class,
        'drivers' => \App\Http\Middleware\DriverMiddleware::class,
