$(function () {
    ...
    $settingsFormOne.on('submit', function (e) {
        ...
        if ($settingsFormOne.parsley().isValid()) {
            ...
            $.ajax({
                url: APP_URL + '/company_approval_email_settings_form_one',
                type: 'POST',
                dataType: 'json',
                data: formData,
                contentType: false,
    ...
    $settingsFormTwo.on('submit', function (e) {
        ...
        if ($settingsFormTwo.parsley().isValid()) {
            ...
            $.ajax({
                url: APP_URL + '/company_approval_email_settings_form_two',
                type: 'POST',
                dataType: 'json',
                data: formData,
                contentType: false,
    ...
    $settingsFormThree.on('submit', function (e) {
        ...
        if ($settingsFormThree.parsley().isValid()) {
            ...
            $.ajax({
                url: APP_URL + '/company_approval_email_settings_three',
                type: 'POST',
                dataType: 'json',
                data: formData,
                contentType: false,
