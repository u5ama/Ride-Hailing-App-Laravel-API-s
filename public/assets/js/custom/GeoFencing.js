$(function () {
    ...
    const table = $('#data-table').DataTable({
        ...
        columns: [
            ...
            {data: 'restricted_lat', name: 'restricted_lat'},
            {data: 'restricted_lng', name: 'restricted_lng'},
                ...
                success: function (data) {
                    ...
                    if (data.success === true) {
                        ...
                        if ($('#form-method').val() === 'edit') {
                            setTimeout(function () {
                                window.location.href = APP_URL + '/geo_fencing'
                            }, 1000);
                        }
    ...
    function deleteRecord(value_id) {
        $.ajax({
            type: 'DELETE',
            url: APP_URL + '/geo_fencing' + '/' + value_id,
            success: function (data) {
                successToast(data.message, 'success');
                table.draw()
                loaderHide();
