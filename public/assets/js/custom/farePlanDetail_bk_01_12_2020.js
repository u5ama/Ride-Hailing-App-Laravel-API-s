...
$("#fpd_country_id,#fpd_transport_type_id,#fpd_in_or_out_city").select2();
...
$('[data-toggle="tooltip"]').tooltip();
    ...
    $(".add-new").click(function(){
        ...
        $('#selectAlert').show();
        $('#selectAlert').html('<span style="color:red">**Please select Country and Transport Type From given above selection**</span>')
    }
