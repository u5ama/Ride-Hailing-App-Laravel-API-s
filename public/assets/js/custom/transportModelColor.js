$(function () {
    ...
    const table = $('#data-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: APP_URL + '/transportModelColor',
            type: 'GET',
        },
        columns: [
            {data: 'id', name: 'id'},
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.success === true) {
                        ...
                        setTimeout(function () {
                            window.location.href = APP_URL + '/transportModelColor'
                        }, 1000);
   ...
   // $("#type_id,#make_id,#model_id").select2();
    $('.dropify').dropify();
    ...
    function deleteRecord(value_id) {
        $.ajax({
            type: 'DELETE',
            url: APP_URL + '/transportModelColor' + '/' + value_id,
            success: function (data) {
                successToast(data.message, 'success');
                table.draw()
                loaderHide();
