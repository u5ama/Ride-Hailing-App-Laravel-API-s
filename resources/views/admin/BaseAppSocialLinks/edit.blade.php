            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" data-parsley-validate="" id="addEditForm" role="form">
                        @csrf
                        <input type="hidden" id="edit_value" name="edit_value" value="{{ $base_social_link->id }}">
                        ...
                        <div class="row row-sm">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           name="basl_title"
                                           id="basl_title"
                                           value="{{$base_social_link->basl_title}}"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           id="basl_description"
                                           value="{{$base_social_link->basl_description}}"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           name="basl_url"
                                           id="basl_url"
                                           value="{{$base_social_link->basl_url}}"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="screen_info">Old Link Icon<span
                                            class="error">*</span></label>
                                    <img src="{{asset($base_social_link->basl_image)}}" height=\"50\"/>
                                </div>
                            </div>
                                    ...
                                    <select class="form-control" id="basl_order_by" name="basl_order_by">
                                        @if(count($socialLinks) > 0)
                                            @foreach($socialLinks as $key=>$socialLink)
                                                <option value="{{$key+2}}"
                                                        @if($base_social_link->basl_order_by == $key+2) selected @endif >{{$key+2}}</option>
                                            @endforeach
                                        @else
                                            <option value="1"
                                                    @if($base_social_link->basl_order_by == 1) selected @endif >1
                                            </option>
                                        @endif
                                    </select>
                                </div>
