                    ...
                    <div class="breadcrumb-header justify-content-between">
                        <div class="my-auto">
                            <div class="d-flex justify-content-center">
                                <h4 class="content-title mb-0 mt-4">Driver Status Report</h4>
                                ...
                                <div class="breadcrumb-header">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="filterWithCountry" name="country"
                                                onchange="getCompanies(this.value)">
...
@section('js')
    ...
    <script src="{{URL::asset('assets/js/custom/DriverStatusReport.js')}}"></script>
