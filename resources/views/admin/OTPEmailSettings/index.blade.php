...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">OTP Email Settings</h4>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control"
                                                      ...
                                                      required>
                                            @if($headerTrans != ''){{ $headerTrans->translateOrNew($language->language_code)->emh_description }}@endif</textarea>
                                        </div>
                                    </div>
                                @endforeach
                                <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control"
                                                      ...
                                                      required>
                                                 @if($bodyTrans != ''){{ $bodyTrans->translateOrNew($language->language_code)->emb_title_text_after_name }}@endif</textarea>
                                        </div>
                                    </div>
                                @endforeach
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control"
                                                      ...
                                                      required>
                                                 @if($bodyTrans != ''){{ $bodyTrans->translateOrNew($language->language_code)->emb_body_text_after_button }}@endif</textarea>
                                        </div>
                                    </div>
                                @endforeach
...
@endsection
@section('js')
    <script src="{{URL::asset('assets/js/custom/OTPEmailSettings.js')}}"></script>
