...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Add Base APP SMTP Credential</h4>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" data-parsley-validate="" id="addEditForm" role="form">
                        @csrf
                        <input type="hidden" id="edit_value" name="edit_value" value="{{ $base_app_SMTP->id }}">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           name="MAIL_DRIVER"
                                           id="MAIL_DRIVER"
                                           value="{{ $base_app_SMTP->MAIL_DRIVER }}"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           name="MAIL_USERNAME"
                                           id="MAIL_USERNAME"
                                           value="{{ $base_app_SMTP->MAIL_USERNAME }}"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           name="MAIL_PASSWORD"
                                           id="MAIL_PASSWORD"
                                           value="{{ $base_app_SMTP->MAIL_PASSWORD }}"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           id="MAIL_ENCRYPTION"
                                           value="{{ $base_app_SMTP->MAIL_ENCRYPTION }}"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           value="{{ $base_app_SMTP->MAIL_FROM_ADDRESS }}"
