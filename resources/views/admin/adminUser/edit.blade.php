                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           name="name"
                                           id="com_name"
                                           placeholder="Admin Name" value="{{$admin->name}}" required/>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           placeholder="Admin Contact Number" value="{{$admin->mobile_no}}" required/>
                                    <div class="help-block with-errors error"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           name="email"
                                           id="email"
                                           placeholder="Admin Email" value="{{$admin->email}}" required/>
                                    <div class="help-block with-errors error"></div>
                                </div>
                            </div>
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="admin_role" required id="com_role">
                                        ...
                                        @if(!empty($admin->admin_role))
                                            {{ \App\Utility\Utility::create_option("permission_roles","id","role_name",$admin->admin_role) }}
                                        @else
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control"
                                           name="admin_logo"
                                           id="com_logo"
                                           placeholder="Company Logo" data-default-file="{{url($admin->profile_pic)}}"/>
                                    <div class="help-block with-errors error"></div>
                                </div>
                            </div>
