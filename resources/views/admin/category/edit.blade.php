...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Edit Featured Category</h4>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control dropify"
                                           name="image"
                                           data-default-file="{{URL::asset($category->image)}}"
                                           id="image"/>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control"
                                                  ...
                                                  placeholder="{{ $language->name }} Name" required>{{ $category->translateOrNew($language->language_code)->name }}
                                        </textarea>
                                        <div class="help-block with-errors error"></div>
                                    </div>
                                </div>
