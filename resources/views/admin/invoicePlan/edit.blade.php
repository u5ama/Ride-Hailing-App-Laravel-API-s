...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Edit Bank Commission</h4>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" data-parsley-validate="" id="addEditForm" role="form">
                        @csrf
                        <input type="hidden" id="edit_value" name="edit_value" value="{{ $invoice->id }}">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control"
                                        ...
                                        <option value="creditcard" @if( $invoice->ip_payment_type == "creditcard") selected @endif>Credit Card</option>
                                        <option value="knet" @if( $invoice->ip_payment_type == "knet") selected @endif>Knet - Debit Card</option>
                                    </select>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" max="99" class="form-control"
                                           ...
                                           value="{{$invoice->ip_bank_commesion}}"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" max="99" class="form-control"
                                           ...
                                           value="{{$invoice->ip_bank_fixed_commesion}}"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" max="99" class="form-control"
                                           ...
                                           value="{{$invoice->ip_bank_extra_charges}}"
...
<!--                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" max="99" class="form-control"
                                           ...
                                           value="{{$invoice->ip_whipp_commesion}}"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" max="99" class="form-control"
                                           ...
                                           value="{{$invoice->ip_driver_commesion}}"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" max="99" class="form-control"
                                           ...
                                           value="{{$invoice->ip_company_commesion}}"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="ip_is_default" name="ip_is_default">
                                        <option value="1" @if( $invoice->ip_is_default == "1") selected @endif>Yes
                                        </option>
                                        <option value="0" @if( $invoice->ip_is_default == "0") selected @endif>No
                                        </option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="ip_start_date" name="ip_start_date"
                                               placeholder="Start date" value="{{$invoice->ip_start_date}}" type="date"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="ip_end_date" name="ip_end_date"
                                               placeholder="End Date" type="date" value="{{$invoice->ip_end_date}}"
                                               autocomplete="off" required>
                                    </div>
                                </div>
                            </div>
