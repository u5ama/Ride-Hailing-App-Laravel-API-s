...
@section('page-header')
    ...
    <div class="card mt-3">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12 col-xl-12" style="text-align: center;display: flex; justify-content: center;">
                    <h4 class="content-title mb-0 mt-4">Ledger Report</h4>
                </div>
                <br>
                    ...
                    <div class="row mt-5">
                        <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="company_filter" id="company_filter" onchange="getPassengerORDriverByCompany(this.value)" required="">
                                        <option value="">Select Company</option>
                                        @foreach($companies as $company)
                                            <option value="{{$company->id}}" @if(isset($company_filter) && $company_filter == $company->id){{'selected'}}@endif>{{$company->com_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                        </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="filterWithCategory">Type</label>
                        ...
                        <div class="col-md-2">
                                <div class="form-group">
                                    <label for="cust_id">Select One</label>
                            ...
                            ?>
                             ...
                             if(isset($type) && $type == 'Driver'){
                              ...
                              ?>
                               ...
                               <tr>
                                    <td><?php
                                    $datetime =  Utility:: convertTimeToUSERzone($row->ci_invoice_date,Utility::getUserTimeZone(auth()->guard('admin')->user()->time_zone_id ));
