                    ...
                    @if(isset($rideBookSchedule))
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{ Utility:: convertTimeToUSERzone( $rideBookSchedule->rbs_driving_wait_start_time,Utility::getUserTimeZone(auth()->guard('admin')->user()->time_zone_id))  }}</td>

                                <td>{{ Utility:: convertTimeToUSERzone( $rideBookSchedule->rbs_driving_wait_end_time,Utility::getUserTimeZone(auth()->guard('admin')->user()->time_zone_id))  }}</td>
