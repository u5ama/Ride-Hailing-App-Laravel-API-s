    ...
    <div class="row">
        <div class="col-md-6">
            <div class="breadcrumb-header justify-content-between">
                <div class="my-auto">
                    <div class="d-flex">
                        <h4 class="content-title mb-0 my-auto">Ride Cancel By Passenger</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="start_date_cancel_pass" id="start_date_cancel_pass"
                        ...
                        <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="end_date_cancel_pass" id="end_date_cancel_pass"
                                           class="form-control datepicker-autoclose" placeholder="Please select end date">
                                </div>
                        </div>
                        <div class="col-md-2">
                                <button class="filterCancel btn btn-outline-primary" type="button" style="margin-top: 30px; width: 100%">
                                    Filter
                                </button>
                        </div>
                    </div>
...
@section('content')
    ...
    <div class="modal" id="modaldemo4">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">View Total Cancel Detail By Passenger</h6>
                    <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span
                            aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
...
@section('js')
    ...
    <script src="{{URL::asset('assets/js/custom/rideCancelByPassenger.js')}}"></script>
