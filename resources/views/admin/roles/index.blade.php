...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">User Roles</h4>
                <span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Settings</span>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{route('admin::roles.create')}}" class="btn btn-info  mr-2">
...
@endsection
@section('js')
    <script src="{{URL::asset('assets/js/custom/roles.js')}}"></script>
