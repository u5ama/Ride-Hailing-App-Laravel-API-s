...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Edit Transport Make</h4>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" data-parsley-validate="" id="addEditForm" role="form">
                        @csrf
                        <input type="hidden" id="edit_value" name="edit_value" value="{{ $transportMake->id }}">
                                    ...
                                    <select id="tm_type_ref_id" name="tm_type_ref_id" class="form-control" required>
                                        ...
                                        @foreach($transportTypes as $type)
                                            ...
                                            <option value="{{ $type->id }}"
                                                    @if($type->id==$transportMake->tm_type_ref_id) selected @endif
                                            >{{ $type->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                               ...
                                               value="{{ $transportMake->translateOrNew($language->language_code)->name }}"
