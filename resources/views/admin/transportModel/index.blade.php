...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Transport Model</h4>

            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('admin::transportModel.create') }}" class="btn btn-info  mr-2">
...
@section('js')
    ...
    <script src="{{URL::asset('assets/js/custom/transportModel.js')}}?v={{ time() }}"></script>
@endsection
