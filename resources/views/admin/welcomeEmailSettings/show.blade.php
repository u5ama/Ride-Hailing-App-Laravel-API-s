...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">View Welcome Passenger Email Template</h4>
                                                    ...
                                                    <td class="content-cell">
                                                        <div class="f-fallback">
                                                            <p style="font-size: 24px;">
                                                                <b>{{$bodyTrans->emb_title_text_bf_name}}, Tester!</b>
                                                            </p>
                                                                            ...
                                                                            <tr>
                                                                                <td align="center">
                                                                                    <a href="#"
                                                                                       ...
                                                                                       target="_blank">{{$bodyTrans->emb_body_text_bf_button}}</a>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
