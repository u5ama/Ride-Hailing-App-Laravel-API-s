            ...
            <div class="row">
                <div class="col-md-3 col-xl-3">
                    <div class="breadcrumb-header justify-content-between" style="text-align: center;display: flex;">
                                <h4 class="content-title mb-0 mt-5">{{ config('languageString.drivers_status_report') }}</h4>
                                    ...
                                    <div class="form-group" style="text-align: center;">
                                        ...
                                        <select class="form-control" name="filterByDriverVehicle[]"
                                            ...
                                            @if(isset($drivers))
                                                ...
                                                @endforeach
                                            @endif
        {{--                                    {{ \App\Utility\Utility::create_option_where("driver_profiles","car_registration","car_registration",$company_id) }}--}}
                                        </select>
        ...
        <div class="col-md-4">
            <div class="online-card card" style="background: #55b755 !important;">
                <div class="card-body">
                    ...
                    <h6 id="onlineDrivers">{{$onlineDrivers}}</h6>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="offline-card card" style="background: #ef5050eb !important;">
                <div class="card-body">
                    ...
                    <h6 id="offlineDrivers">{{$offlineDrivers}}</h6>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="offline-card card" style="background: #e2d32b !important;">
                <div class="card-body">
                    ...
                    <h6 id="busyDrivers">{{$busyDriversCount}}</h6>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table mg-b-0 text-md-nowrap" id="data-table">
                            ...
                            <tr>
                                ...
                                <th>{{ config('languageString.vehicle_type_title') }}</th>
                                <th>{{ config('languageString.vehicles_title') }}</th>
                                <th>{{ config('languageString.license_title') }}</th>
                                <th>{{ config('languageString.mobile_title') }}</th>
                                <th>{{ config('languageString.captain_name_title') }}</th>
                                <th>{{ config('languageString.company_name_title') }}</th>
                                <th>{{ config('languageString.driver_status_title') }}</th>
                                <th>{{ config('languageString.country_title') }}</th>
                                <th>{{ config('languageString.city_title') }}</th>
...
@section('js')
    ...
    <script src="{{URL::asset('assets/js/custom/company/DriverStatusReport.js')}}"></script>
