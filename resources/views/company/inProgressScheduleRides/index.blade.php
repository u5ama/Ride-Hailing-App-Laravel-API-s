            ...
            <div class="row">
                <div class="col-md-3 col-xl-3">
                    <div class="breadcrumb-header justify-content-between" style="text-align: center;display: flex;">
                                <h4 class="content-title mb-0 mt-4">{{ config('languageString.inprogress_rides') }}</h4>
                    ...
                    <div class="table-responsive">
                        <table class="table mg-b-0 text-md-nowrap" id="data-table">
                            ...
                            <tr>
                                ...
                                <th>{{ config('languageString.schedule_ride_on_title') }}</th>
                                <th>{{ config('languageString.schedule_for_title') }}</th>
                                <th>{{ config('languageString.ride_tracking_url_title') }}</th>
...
@endsection
@section('js')
    <script src="{{URL::asset('assets/js/custom/company/inProgressScheduleRides.js')}}"></script>
