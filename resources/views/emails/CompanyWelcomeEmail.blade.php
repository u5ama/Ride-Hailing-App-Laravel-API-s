            ...
            <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tr>
                    <td class="header"
                        ...
                        <!--[if mso]>
                        <table width="100%"><tr><td align="center"><img width="570" src="{{URL::asset('assets/emails/company_welcome-en.png')}}" alt="ITEAMS" style=" width: 570px; border: 0; text-decoration:none;"></td></tr></table>
                        <div style="display:none">
                        <![endif]-->

                            <img src="{{URL::asset('assets/emails/company_welcome-en.png')}}" alt="Logo"
