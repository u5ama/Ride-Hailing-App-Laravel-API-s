                            ...
                            <div class="col_cont" style="width:100% !important;">
                                ...
                                <div
                                    ...
                                    <div align="center" class="img-container center fixedwidth"
                                        ...
                                        @if($langtxt == 'en')
                                            <img align="center" alt="I'm an image" border="0" class="center fixedwidth" src="{{URL::asset('assets/emails/cancelReceipt-en.png')}}" width="640" alt=""  style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 640px; display: block;">
                                        @else
                                            <img align="center" alt="I'm an image" border="0" class="center fixedwidth" src="{{URL::asset('assets/emails/cancelReceipt-en.png')}}" width="640" alt=""  style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 640px; display: block;">
                                        @endif
                                    ...
                                    <div
                                        ...
                                        <div class="txtTinyMce-wrapper"
                                            ...
                                            <p style="font-size: 30px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 36px; margin: 0;">
                                                @if($langtxt == 'en')
                                                    <span style="font-size: 30px; color: white;"><strong>Ride is Cancelled</strong></span>
                                                @elseif($langtxt == 'ur')
                                                    <span style="font-size: 30px; color: white;"><strong>سواری منسوخ کردی گئی ہے</strong></span>
                                                @else
                                                    <span style="font-size: 30px; color: white;"><strong>تم إلغاء الركوب</strong></span>
                                                @endif
