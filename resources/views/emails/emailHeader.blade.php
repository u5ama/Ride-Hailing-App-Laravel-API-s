                    ...
                    <td class="header"
                        ...
                        <a href="#"
                           style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Nunito Sans', sans-serif; position: relative; color: #3d4852; font-size: 19px; font-weight: bold; text-decoration: none; display: block;margin-bottom:-8px;">
                               ...
                               <!--[if mso]>
                            <table width="100%"><tr><td align="center"><img width="570" src="{{URL::asset('assets/emails/verify-en.png')}}" alt="ITEAMS" style=" width: 570px; border: 0; text-decoration:none;"></td></tr></table>
                            <div style="display:none">
                            <![endif]-->

                                <img src="{{URL::asset('assets/emails/verify-en.png')}}" alt="Logo"
                                     style="min-width: 50px; max-width: 570px !important;margin-bottom: -7px;">
                ...
                <tr>
                    <td class="body" width="100%" cellpadding="0"
                        ...
                        <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                               role="presentation"
                               style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Nunito Sans', sans-serif; position: relative; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 570px; background-color: #773DBD; border-color: #e8e5ef; border-radius: 2px; border-width: 1px; box-shadow: 0 2px 0 rgba(0, 0, 150, 0.025), 2px 4px 0 rgba(0, 0, 150, 0.015); margin: 0 auto; padding: 0; width: 570px;">
                            <!-- Body content -->
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <h2 style="font-size: 20pt;color: white;letter-spacing:2.1pt;line-height: 26pt;
									font-weight: bold;font-style: italic">
                                        {{$headerTrans->emh_title}}
                                    </h2>
                                </td>
                            </tr>
                        </table>
                    ...
                    <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                        ...
                        <tr>
                            ...
                            <![endif]-->
                                        ...
                                        <img src="{{URL::asset('assets/emails/verify-ar.png')}}"alt="Logo"
                                             style="max-width: 570px !important;margin-bottom: -7px;">
                                ...
                                <table class="inner-body" align="center" width="570" cellpadding="0"
                                    ...
                                    <tr>
                                        <td dir="rtl" class="content-cell"
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Nunito Sans', sans-serif; position: relative; max-width: 100vw;text-align:center">
                                            <h2 style="font-size: 20pt;color: white;letter-spacing:2.1pt;line-height: 26pt;font-weight: bold;font-style: italic">
                                                {{$headerTrans->emh_title}}
                                            </h2>
                                        </td>
                                    </tr>
